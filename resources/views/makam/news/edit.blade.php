...
@section('konten')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Perbarui berita atau artikel</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('makam.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($news->image_url)
                                <div class="mb-2">
                                    <img src="{{ Storage::url($news->image_url) }}" alt="Current image"
                            ...
                            @enderror
                            <small class="text-muted mt-1 d-block">
                                <i class="bi bi-info-circle"></i> Format: JPEG, PNG, JPG, GIF, WebP. Maksimal 2MB. Biarkan kosong jika tidak ingin mengubah gambar.
                            </small>
                ...
                <div class="card-body">
                    <div id="previewArea">
                        <p class="text-muted text-center py-4 mb-0">
                            <i class="bi bi-arrow-left"></i> Edit konten untuk memperbarui pratinjau
                        </p>
                    </div>
                </div>
            </div>
